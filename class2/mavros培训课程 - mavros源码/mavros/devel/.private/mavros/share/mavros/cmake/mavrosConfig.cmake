...
if("TRUE" STREQUAL "TRUE")
  set(mavros_SOURCE_PREFIX /home/nvidia/mavros/src/mavros/mavros)
  set(mavros_DEVEL_PREFIX /home/nvidia/mavros/devel/.private/mavros)
  set(mavros_INSTALL_PREFIX "")
  set(mavros_PREFIX ${mavros_DEVEL_PREFIX})
else()
  set(mavros_SOURCE_PREFIX "")
  set(mavros_DEVEL_PREFIX "")
  set(mavros_INSTALL_PREFIX /home/nvidia/mavros/install)
...
if(NOT "/home/nvidia/mavros/src/mavros/mavros/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(mavros_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/mavros/src/mavros/mavros/include;/usr/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mavros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/mavros/src/mavros/mavros/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/mavros/devel/.private/mavros/lib;/home/nvidia/ws_cartographer/devel_isolated/cartographer_rviz/lib;/home/nvidia/ws_cartographer/install_isolated/lib;/home/nvidia/ws_rplidar/devel/lib;/home/nvidia/mavros/devel/lib;/opt/ros/kinetic/lib)
