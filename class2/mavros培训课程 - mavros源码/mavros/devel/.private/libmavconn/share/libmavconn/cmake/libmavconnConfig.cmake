...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/nvidia/mavros/src/mavros/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/nvidia/mavros/devel/.private/libmavconn)
  ...
  set(libmavconn_INSTALL_PREFIX /home/nvidia/mavros/install)
...
if(NOT "/home/nvidia/mavros/src/mavros/libmavconn/include;/usr/include;/home/nvidia/mavros/devel/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/mavros/src/mavros/libmavconn/include;/usr/include;/home/nvidia/mavros/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/mavros/src/mavros/libmavconn/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/mavros/devel/.private/libmavconn/lib;/home/nvidia/ws_cartographer/devel_isolated/cartographer_rviz/lib;/home/nvidia/ws_cartographer/install_isolated/lib;/home/nvidia/ws_rplidar/devel/lib;/home/nvidia/mavros/devel/lib;/opt/ros/kinetic/lib)
